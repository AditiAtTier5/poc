package redbeltgym.selenium.api.design;
...
public interface Browser {
	...
	*/
	...
	/**
	 * This method will verify browser actual url with expected
	 * @param urlContains   - The word to be checked within url
	 * @author Aditi - Tier5
	 * @return true if the given object represents a String which is present within the url, false otherwise
	 */		
	boolean verifyUrlContains(String urlContains);
